...
const CustomerOrderForm = ({ customerId, onClose, onSubmit }) => {
  ...
  // Mock products - replace with actual product API
  const availableProducts = [
    { 
      ...
      price: 25.00, 
      category: 'Natural',
      description: '500ml bottles - Pure spring water',
      image: '💧'
    },
    { 
      id: 2, 
      ...
      price: 45.00, 
      category: 'Premium',
      description: '1L bottles - Rich in minerals',
      image: '🏔️'
    },
    { 
      id: 3, 
      ...
      price: 35.00, 
      category: 'Sparkling',
      description: '330ml bottles - Naturally carbonated',
      image: '✨'
    },
    { 
      id: 4, 
      ...
      price: 55.00, 
      category: 'Premium',
      description: '500ml bottles - pH balanced',
      image: '🌿'
    }
  ];
  ...
  return (
    <div className="space-y-6 max-h-[70vh] overflow-y-auto">
      {/* Product Catalog */}
      <div>
        <h3 className="text-lg font-medium text-gray-800 mb-4">Select Products</h3>
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-lg font-bold text-purple-600 mt-1">₹{product.price.toFixed(2)}</p>
                    </div>
                    <button
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        ...
        {total < 500 && (
          <p className="text-sm text-blue-700">
            • Delivery charges: ₹50 (Add ₹{(500 - total).toFixed(2)} more for free delivery)
          </p>
        )}
      </div>
